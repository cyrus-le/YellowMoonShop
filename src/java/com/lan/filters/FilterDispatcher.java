...
public class FilterDispatcher implements Filter {
    ...
    private final static Logger LOGGER = Logger.getLogger(FilterDispatcher.class);
    ...
    private static final String BEGIN_PAGE = "SearchProductController";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            if ((uri.contains(".js") || uri.contains(".jpg")
                    || uri.contains("png")
                    || uri.contains("UpdateController")
                    || uri.contains("CreateController")
                    || uri.contains("jpeg"))
                    && !uri.contains("jsp")) {
