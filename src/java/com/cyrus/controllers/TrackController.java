...
import com.cyrus.dtos.OrderDetailsDTO;
...
public class TrackController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            OrderDetailsDTO dto = dao.getOrder(orderID, ((UserDTO) ses.getAttribute("USER")).getUserID());
            if (dto != null) {
                request.setAttribute("ORDER_DETAIL", dto);
            }
            url = SUCCESS;
