<%-- Document : update Created on : Oct 19, 2020, 10:31:34 AM Author : Admin --%>
...
<html>
    <head>
        ...
        <title>Update Moon Cake Page</title>
    </head>
    ...
    <body class="bg-light">
        ...
        <div class="container bg-white">
            ...
            <form action="UpdateController" method="POST" enctype="multipart/form-data" id="post">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" type="text" name="txtName" value="${param.txtName}"/>
                        <font color="red">${requestScope.ERROR.productNameError}</font> 
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <input class="btn btn-outline-success form-control" type="submit" name="btnAction" value="Update" />
